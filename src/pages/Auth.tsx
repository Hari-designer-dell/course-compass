...
import { Mail, Lock, User, ArrowRight, Loader2, Phone, ArrowLeft } from "lucide-react";
                ...
                >
                  ...
                  <AnimatePresence mode="wait">
                    {authMethod === "email" ? (
                      ...
                      >
                        <div>
                          ...
                          <div className="relative mt-1.5">
                            ...
                            <Input id="phone" type="tel" placeholder="+1 234 567 8900" value={phone}
                              onChange={(e) => setPhone(e.target.value)} required disabled={otpSent}
                              className="pl-10 h-12 bg-secondary/50 border-border" />
                          </div>
                        </div>
                        {otpSent && (
                          <motion.div initial={{ opacity: 0, height: 0 }} animate={{ opacity: 1, height: "auto" }}>
                            ...
                            <div className="relative mt-1.5">
                              <Lock className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-muted-foreground" />
                              <Input id="otp" type="text" placeholder="Enter 6-digit code" value={otp}
                        ...
                        <Button type="submit" className="w-full h-12 font-medium" disabled={loading}>
                          {loading ? <Loader2 className="w-4 h-4 animate-spin" /> : (
                            <>{otpSent ? "Verify Code" : "Send OTP"} <ArrowRight className="w-4 h-4 ml-2" /></>
                          )}
                        </Button>
                        {otpSent && (
                  ...
                  {authMethod === "email" && (
                    <p className="text-center text-sm text-muted-foreground mt-6">
                      ...
                      <button onClick={() => setView(isLogin ? "signup" : "login")}
