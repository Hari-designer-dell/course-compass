...
import { ChevronRight, Sparkles, GraduationCap, Users, BarChart3, BookOpen } from "lucide-react";
      ...
      <div className="min-h-screen bg-background flex flex-col">
        ...
        <main className="flex-1 flex items-center justify-center px-6">
          ...
          >
            ...
            {/* Feature highlights inspired by the reference */}
            <div className="flex items-center justify-center gap-6 mt-10">
              {[
                { icon: BookOpen, label: "4 Subjects" },
                { icon: BarChart3, label: "Popularity Scoring" },
                { icon: Users, label: "Real Udemy Data" },
              ].map(({ icon: Icon, label }) => (
                <div key={label} className="flex items-center gap-1.5 text-muted-foreground text-sm">
